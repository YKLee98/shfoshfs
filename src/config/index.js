...
const config = {
  ...
  shopify: {
    ...
    defaultKPOPCollectionGid: process.env.SHOPIFY_BUNJANG_KPOP_COLLECTION_GID,
    defaultKIDULTCollectionGid: process.env.SHOPIFY_BUNJANG_KIDULT_COLLECTION_GID,
    appProxy: {
  ...
  bunjang: {
    ...
    filterkpopCategoryIds: process.env.BUNJANG_KPOP_FILTER_CATEGORY_IDS ? process.env.BUNJANG_KPOP_FILTER_CATEGORY_IDS.split(',').map(id => id.trim()) : [],
    filterkidultCategoryIds: process.env.BUNJANG_KIDULT_FILTER_CATEGORY_IDS ? process.env.BUNJANG_KIDULT_FILTER_CATEGORY_IDS.split(',').map(id => id.trim()) : [],
